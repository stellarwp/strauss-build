...
class StraussPlugin implements PluginInterface, Command
{
	private $io;
	...
	private function runStrauss()
	{
		...
		if (file_exists('vendor/lucatume/di52')) {
			...
			file_put_contents('vendor-prefixed/lucatume/di52/aliases.php', '<?php');
		}

		file_put_contents('.strauss-rebuild', '');
	}
}
